...
const NavMenu = ({showMenu}) => {
  return (
   <ul className={`absolute ${showMenu ? 'left-0': '-left-[200%]'} top-14 bg-gradient-to-tr from-gray-500 via-gray-800 to-black md:bg-none duration-300 md:transition-none h-screen w-[70vw]  md:h-full md:w-auto md:static flex flex-col md:flex-row items-start md:items-center p-4 md:p-0 gap-2 text-white md:text-inherit z-100`}>
